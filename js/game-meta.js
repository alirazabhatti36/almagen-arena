(function () {
    ...
    wrapper.innerHTML = [
        ...
        '<article class="game-meta-block"><h2>Video Preview</h2><div class="video-placeholder">Video trailer placeholder</div></article>',
        ...
        '<article class="game-meta-block"><h2>Game Info</h2><div class="info-list"><p><strong>Difficulty:</strong> Medium</p><p><strong>Age Rating:</strong> 7+</p><p><strong>Release Date:</strong> Jul 2026</p><p><strong>Developer:</strong> ' + game.developer + '</p></div></article>',
    ...
    style.textContent = [
        ...
        '.video-placeholder{height:110px;border-radius:10px;border:1px dashed rgba(255,255,255,.2);display:grid;place-items:center;color:rgba(255,255,255,.66);font-size:.82rem;background:rgba(255,255,255,.03);}',
        ...
        '.info-list p{font-size:.82rem;margin-bottom:5px;color:rgba(255,255,255,.8);}',
